document.addEventListener('DOMContentLoaded', async () => {
    ...
    settingsBtn.addEventListener('click', () => {
        alert('API key is pre-configured for this extension!');
    });
        ...
        chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
            ...
            `);
              ...
              <p style="font-family: monospace; background: #f5f5f5; padding: 8px; border-radius: 4px;">
                https://leetcode.com/problems/<em>problem-name</em>/
              </p>
              <button onclick="location.reload()" style="margin-top: 10px; padding: 8px 16px; background: #007bff; color: white; border: none; border-radius: 4px; cursor: pointer;">
                Try Again
              </button>
    ...
    function initializeConversation(problem) {
        conversationHistory = [
            {
                role: "system",
                content: `You are an expert coding Expert and mentor for LeetCode problems. Your goal is to guide students to understand and solve problems independently.
